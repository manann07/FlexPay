...
function Register() {
  ...
  return (
    <div className="flex min-h-screen flex-col px-6 py-6 md:py-10 bg-[#8DCFAB]">
      <div className="mx-auto w-full max-w-6xl ">
        ...
        <div className="items-center gap-10 md:flex">
          ...
          <form onSubmit={handleRegister} className="mt-8 space-y-6">
            ...
            <button type="submit" className="flex w-full justify-center rounded-md bg-[#8DCFAB] px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-[#7ec89f] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#8DCFAB]">
              Create account
            </button>
